...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Don't set loading to false here as component will unmount
    } catch (err: any) {
          ...
          <CardContent>
            ...
            <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-md text-sm">
              ...
              <p className="text-blue-700 dark:text-blue-200 text-xs">
                Admin: admin@smartretailx.com / Admin@123<br />
                Owner: owner@smartretailx.com / Admin@123<br />
                Customer: customer@smartretailx.com / Customer@123
              </p>
            </div> */}
          </CardContent>
        </Card>
