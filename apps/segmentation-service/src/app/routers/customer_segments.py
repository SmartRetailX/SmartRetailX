...
from app.services.customer_segmentation_service import generate_segements_by_catagory_preference, generate_segments_by_rfm, get_customer_segements_by_category_preference, get_customer_segements_by_rfm, get_customer_segment_profile_by_rfm_and_category
