...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/bi-dashboard-services-gateway/src/generated/prisma",
    "bi-dashboard-services-gateway/src/generated/prisma",
  ]
...
path.join(process.cwd(), "apps/bi-dashboard-services-gateway/src/generated/prisma/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/bi-dashboard-services-gateway/src/generated/prisma/schema.prisma")
