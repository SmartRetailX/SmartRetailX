...
export function ColorPicker({
  ...
  const [background, setBackground] = useState(value || '#B4D455');
  ...
  return (
    <div
      className='w-full h-full preview flex justify-center items-center rounded !bg-cover !bg-center transition-all'
      style={{ background }}
    >
      <GradientPicker
    ...
    <Popover>
      ...
      <PopoverContent className='w-64'>
        <Tabs defaultValue={defaultTab} className='w-full'>
          <TabsList className='w-full mb-4' hidden={onlySolid}>
