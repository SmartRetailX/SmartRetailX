...
import { VirtualizedPageSelect } from './page-selector';
        ...
        <div className='flex items-center gap-2'>
          ...
          >
            <SelectTrigger size='default'>
              <SelectValue placeholder={pageSize} className='focus:outline-none' />
            </SelectTrigger>
            <SelectContent>
      ...
      <div className='flex items-center gap-2 justify-end w-full sm:w-auto sm:ml-auto'>
        ...
        <Pagination className='flex items-center gap-2 justify-end'>
          <PaginationContent>
            ...
            {/* All page dropdown */}
            <PaginationItem>
              <VirtualizedPageSelect
                value={pageIndex + 1}
                pageCount={pageCount}
                onChange={(page) => onPaginationChange({ pageIndex: page - 1, pageSize })}
              />
            </PaginationItem>
          </PaginationContent>
        </Pagination>
