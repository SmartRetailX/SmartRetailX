...
// Define the country tuple type
export type CountryEntry = [string, ICountry];

// Get country by code
export const getCountryByCode = (code: string): ICountry | undefined => {
  return countries.find(([countryCode]) => countryCode === code)?.[1];
};
...
export const getCurrencies = (): string[] => {
  ...
  countries.forEach(([, country]) => {
    country.currency.forEach((curr) => currencySet.add(curr));
  });
